...
class ArbitrageOpportunity(Base, TimestampMixin):
    ...
    fx_rate_to_usd: Mapped[float] = mapped_column(Float, default=1.0)
    gross_spread: Mapped[float] = mapped_column(Float)
    trigger_hyperliquid_bid: Mapped[float] = mapped_column(Float, default=0.0)
    trigger_hyperliquid_ask: Mapped[float] = mapped_column(Float, default=0.0)
    trigger_mt5_bid: Mapped[float] = mapped_column(Float, default=0.0)
    trigger_mt5_ask: Mapped[float] = mapped_column(Float, default=0.0)
    unit_cost: Mapped[float] = mapped_column(Float, default=0.0)
    unit_net_profit: Mapped[float] = mapped_column(Float, default=0.0)
    total_cost: Mapped[float] = mapped_column(Float)
    net_profit: Mapped[float] = mapped_column(Float)
